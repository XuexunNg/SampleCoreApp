...
namespace SampleApp.Infrastructure
{
    ...
    { 
        ...
        public SampleAppDBContext(DbContextOptions<SampleAppDBContext> options, IMediator mediator) : base(options)
        {
...
//                optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=SampleAppDB;Trusted_Connection=True;");
//            }
//        }
    ...
    public class SampleAppContextDesignFactory : IDesignTimeDbContextFactory<SampleAppDBContext>
    {
